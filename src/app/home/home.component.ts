...
@Component({
  selector: 'app-home',
  imports: [FooterComponent, DisponibilidadComponent, ContactComponent, ServiceComponent, AnimationTextComponent, PresentationMsComponent, CardPackComponent, PackDepthComponent, PackExternelComponent, PackExternelOnlyComponent, PackInternelComponent],
